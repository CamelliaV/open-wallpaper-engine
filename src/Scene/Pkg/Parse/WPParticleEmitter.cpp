...
auto AudioResponseScale(slice<float> audio, const WPParticleAudioResponse& response) -> float {
...
auto ResolveEmitterOrigin(slice<WPParticleControlpoint> controlpoints, i32 controlpoint,
...
bool InstanceCanEmit(ref<WPParticleFrame> frame) {
