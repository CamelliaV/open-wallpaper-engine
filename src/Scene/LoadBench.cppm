...
auto CreateSceneLoadBench(ref<str> output_path) -> Option<SceneLoadBenchHandle> {
    ...
    SceneLoadProbeIds ids {
        ...
        .render_texture_plan      = RegisterProbe(registry, "render.resources.texture.plan"),
        .render_texture_decode    = RegisterProbe(registry, "render.resources.texture.decode"),
        .render_texture_upload_prepare =
            RegisterProbe(registry, "render.resources.texture.upload.prepare"),
        .render_texture_upload_wait =
            RegisterProbe(registry, "render.resources.texture.upload.wait"),
